...
dc_2011 <- read.csv('EA_DC_2011_complete.csv', header = T)
dc_2012 <- read.csv('EA_DC_2012_complete.csv', header = T)
dc_2013 <- read.csv('EA_DC_2013_complete.csv', header = T)
dc_2014 <- read.csv('EA_DC_2014_complete.csv', header = T)
dc_2015 <- read.csv('EA_DC_2015_complete.csv', header = T)
dc_2016 <- read.csv('EA_DC_2016_complete.csv', header = T)
dc_2017 <- read.csv('EA_DC_2017_complete.csv', header = T)
dc_2018 <- read.csv('EA_DC_2018_complete.csv', header = T)
dc_2019 <- read.csv('EA_DC_2019_complete.csv', header = T)
dc_2020 <- read.csv('EA_DC_2020_complete.csv', header = T)
dc_2021 <- read.csv('EA_DC_2021_complete.csv', header = T)

colnames(dc_2011)#they are all the same
colnames(dc_2021)

#combine all data

bound <- rbind(dc_2011,dc_2012, dc_2013, dc_2014, dc_2015, dc_2016, dc_2017, dc_2018, dc_2019, dc_2020, dc_2021)
...
MINEWATER <- bound[grep("MINEWATER", bound$sample.sampledMaterialType.label), ]
GROUNDWATER <- bound[grep("GROUNDWATER", bound$sample.sampledMaterialType.label), ]
...
###1 HAYLE
Hayle <- read.csv("Hayle_sampling_points.csv" , header=T)
HayleIDs <- Hayle$ID
...
RR <- read.csv("Red_river_sampling_points.csv" , header=T)
RRIDs <- RR$ID
...
CR <- read.csv("Carnon_river_sampling_points.csv" , header=T)
CRIDs <- CR$ID
...
CoR <- read.csv("Cober_river_sampling_points.csv" , header=T)
CoRIDs <- CoR$ID
...
metals_nut <- read.csv("some_metals_nutrients.csv" , header=F)

Hayle_met_nut <- RIVER_Hayle[grepl(paste(metals_nut$V1, collapse="|"), RIVER_Hayle$determinand.label), ]
Red_met_nut <- Red_RIVER[grepl(paste(metals_nut$V1, collapse="|"), Red_RIVER$determinand.label), ]
Carnon_met_nut <- Carnon_RIVER[grepl(paste(metals_nut$V1, collapse="|"), Carnon_RIVER$determinand.label), ]
Cober_met_nut <- Cober_RIVER[grepl(paste(metals_nut$V1, collapse="|"), Cober_RIVER$determinand.label), ]
